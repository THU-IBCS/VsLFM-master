...
if __name__ == '__main__':
    ...
    parser.add_argument('--savefolder', default="./Data/SR_hylfmanet/")
    ...
    for file in files:
        ...
        ret = ret / (base)
        print(time.time()-t0)
        imwrite(args.savefolder + inputfile[-inputfile[-1::-1].find('/'):][0:-4]+'.tif',np.uint16(ret * 2000), imagej=True, metadata={'axes': 'ZYX'}, compression ='zlib')